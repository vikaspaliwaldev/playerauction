/**
 * Dynamic SVG Jersey / Athlete Avatar Generator for Tournament Players
 * Generates an athletic card avatar featuring the player's sequence number,
 * name, role, and league branding.
 */
...
export function generateJerseyAvatar(playerNumber, name = 'PLAYER', role = '', leagueTag = '7PD VPL') {
  ...
  <!-- Number Accent Underline Bar -->
  <rect x="136" y="204" width="48" height="4" rx="2" fill="${t.a}"/>

  <!-- Bottom Player Name & Role Banner -->
